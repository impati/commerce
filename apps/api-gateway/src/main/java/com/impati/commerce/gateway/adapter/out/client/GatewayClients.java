...
public class GatewayClients {
    ...
    public List<MemberResponse> members() {
        return members.get().uri("/members").retrieve().body(new ParameterizedTypeReference<>() {
        });
    }
    ...
    public AddressResponse addAddress(String memberId, AddAddressRequest request) {
        return members.post()
                .uri("/members/{memberId}/addresses", memberId)
                .body(request)
                .retrieve()
    ...
    public CheckoutResponse checkout(CheckoutRequest request) {
        return orders.post().uri("/checkouts").body(request).retrieve().body(CheckoutResponse.class);
    }

    public OrderResponse order(String orderId) {
        return orders.get().uri("/orders/{orderId}", orderId).retrieve().body(OrderResponse.class);
    }
    ...
    public List<NotificationResponse> notifications() {
        return notifications.get().uri("/notifications").retrieve().body(new ParameterizedTypeReference<>() {
        });
    }
}
