...
public interface CartUseCase {
    ...
    CartDetails changeQuantity(String memberId, String skuId, int quantity, long expectedVersion);

    CartDetails removeItem(String memberId, String skuId, long expectedVersion);
