...
public class InternalPurchaseController {
    ...
    public InternalPurchaseController(OrderUseCase orderUseCase) { this.orderUseCase = orderUseCase; }
    ...
    PurchaseQuoteResponse quote(
            @RequestHeader("X-Member-Id") String memberId, @RequestParam long cartVersion) {
