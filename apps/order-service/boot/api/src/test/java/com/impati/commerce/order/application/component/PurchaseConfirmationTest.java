...
import com.impati.commerce.order.application.port.out.*;
...
class PurchaseConfirmationTest {
    ...
    @Test void rejectsChangedPricesBeforeCreatingAnOrder() {
    ...
    @Test void rejectsAChangedCartVersionEvenWithIdenticalContents() {
        var quote = executor.quote("m", 5);
    ...
    @Test void rejectsMissingQuoteWithoutReadingOtherServices() {
