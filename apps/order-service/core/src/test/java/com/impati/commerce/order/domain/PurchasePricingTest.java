...
class PurchasePricingTest {
    ...
    @Test void detectsPriceChangesEvenWhenTheTotalIsUnchanged() {
    ...
    @Test void bindsTheMemberVersionAndPurchaseContents() {
    ...
    @Test void preservesCurrencyAndRejectsMixedCurrencies() {
