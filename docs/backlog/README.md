...
3~7은 이전에 정한 순서이고 그대로 두었다. 8~10은 결제 정합성 작업(BL-0034·0032·0041·0042)에서 나온 것들이다.

| 순서 | 항목 | 왜 이 순서인가 |
| --- | --- | --- |
| 1 | [BL-0003](bl-0003-session-lookup-coupling.md) 요청당 세션 조회 제거 | 한 서비스 장애가 전 서비스 인증 장애가 된다. 하이브리드로 조회를 없앤다 |
| 2 | [BL-0045](bl-0045-tolerate-member-service-outage.md) 장애 중 기존 신원 인정 | BL-0003만으로는 5분까지만 견딘다. 실제 장애는 그보다 길다. BL-0003이 전제 |
