...
| 순서 | 항목 | 왜 이 순서인가 |
| --- | --- | --- |
| 1 | [BL-0065](bl-0065-concurrent-reservation-transition.md) 재고 예약 동시 종단 명령 | 체크아웃 복구 리뷰에서 실제 경합이 확인됐다. 하위 서비스의 멱등성 경계라 먼저 닫는다 |
...
| [BL-0057](bl-0057-checkout-interruption-recovery.md) 체크아웃 중단 복구 | 외부 처리 후 진행 상태 유실과 미완료 보상·후속 처리. BL-0033·BL-0035·BL-0038을 흡수 |
