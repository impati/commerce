...
1~6은 이전에 정한 순서이고 그대로 두었다. 7~9는 결제 정합성 작업(BL-0034·0032·0041·0042)에서 나온 것들이다.

| 순서 | 항목 | 왜 이 순서인가 |
| --- | --- | --- |
| 1 | [BL-0003](bl-0003-session-lookup-coupling.md) 세션 확인의 가용성 결합과 지연 | 한 서비스 장애가 전 서비스 인증 장애가 된다. 폐기 즉시성을 얼마나 포기할지가 먼저다 |
