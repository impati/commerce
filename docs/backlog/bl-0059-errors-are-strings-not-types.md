...
완료된 [BL-0067](done/bl-0067-preserve-downstream-failure-semantics.md)과 맞닿아 있다. 그쪽은 프로토콜 오류를 도메인 언어로 옮기는 일이고, 이 항목은 옮긴 뒤 그것을 무엇으로 들고 다닐지다. 그쪽이 먼저 서면 여기서 쓸 타입이 생긴다.
